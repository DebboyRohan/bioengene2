          ...
          >
            ...
            <motion.div
              ...
              className="absolute right-0 top-1/2 transform -translate-y-1/2 w-16 h-16 md:w-24 md:h-24 
                bg-[#00bc72]/20 rounded-full flex items-center justify-center text-accent text-2xl"
            >
              🌍
            </motion.div>
          </motion.section>
          ...
          >
            ...
            <motion.div
              ...
              className="absolute left-0 top-1/2 transform -translate-y-1/2 w-16 h-16 md:w-24 md:h-24 
                bg-[#004746]/20 rounded-full flex items-center justify-center text-primary text-2xl"
            >
              🔮
            </motion.div>
          </motion.section>
