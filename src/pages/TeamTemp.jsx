...
function TeamTemp() {
  // Initialize selectedTeam with "Faculty Team" to open it by default
  ...
  const teams = {
    "Faculty Team": [
      {
        id: "pi1",
        name: "Prof. Riddhiman Dhar",
        email: "riddhiman.dhar@iitkgp.ac.in",
        designation: "Principal Investigator, Bioengene",
        linkedin_url: "linkedin.com/in/riddhiman-dhar-16927b51",
        image_url: riddhimandhar,
      },
      {
        id: "pi2",
        name: "Prof. Agneyo Ganguly",
        email: "agneyo@iitkgp.ac.in",
        designation: "Principal Investigator, TRACER",
        image_url: agneyoganguly,
      },
      {
        id: "fa1",
        ...
        linkedin_url: "linkedin.com/in/vinaypatel2482",
        image_url: vinaypatel,
      },
      {
        id: "fa2",
        ...
        designation: "Faculty Advisor",
        linkedin_url: "linkedin.com/in/mainak-bose-938a48276",
        image_url: mainakbose,
      },
      {
        id: "fa3",
        ...
        designation: "Faculty Advisor",
        linkedin_url: "linkedin.com/in/ritesh-ghosh-7b96523a",
        image_url: riteshgosh,
      },
    ],
