      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p
              className={`text-xl ${currentTheme.textSecondary} max-w-3xl mx-auto mb-8`}
            >
              Get in touch to learn more about TRACER and explore collaboration
              opportunities.
            </p>
          </motion.div>

          <div
            className={`${currentTheme.cardBg} shadow-md rounded-lg p-8 border ${currentTheme.cardBorder}`}
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              {/* Sponsorship Lead: Shreya Mohanty*/}
              <motion.div
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
